...
<template>
  ...
  <main
    ...
    class="relative flex min-w-0 w-full flex-1 flex-col overflow-hidden bg-[#f7f8fc]"
  >
    <!-- Header -->
    <header
  ...
  <main
    ...
    class="flex min-w-0 w-full flex-1 flex-col overflow-hidden bg-[#f7f8fc]"
  >
  ...
  <main
    v-else
    class="flex min-w-0 w-full flex-1 flex-col items-center justify-center bg-white"
  >
    <div
